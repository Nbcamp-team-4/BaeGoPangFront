...
export function WidgetSuccessPage() {
  ...
  useEffect(() => {
    async function confirm() {
      ...
      const response = await apiFetch(`/api/orders/${requestData.orderId}/payment/success`, {
        method: 'POST',
        headers: {
    ...
    confirm()
      ...
      .catch((error) => {
        navigate(
          `/fail?code=${error.code}&message=${error.message}&orderId=${orderId}&paymentKey=${paymentKey}&amount=${amount}`
        );
      });
  }, [searchParams]);
