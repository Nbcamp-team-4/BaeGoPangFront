          ...
          <div key={i} style={{border:`1.5px solid ${G[200]}`,borderRadius:"13px",overflow:"hidden",background:"#fff"}}>
            <div style={{padding:"12px"}}>
              <div style={{display:"flex",justifyContent:"space-between",marginBottom:"7px"}}>
                ...
                <div style={{display:"flex",alignItems:"center",gap:"5px"}}><Stars v={r.rating}/>{!r.replied?<Badge bg="#FFEBEE" color="#C62828">미답글</Badge>:<Badge bg="#E8F5E9" color="#2E7D32">완료</Badge>}</div>
              </div>
            ...
            {replyTarget===i && (
              <div style={{borderTop:`1px solid ${G[200]}`,padding:"12px",background:G[50],display:"flex",flexDirection:"column",gap:"9px"}}>
                ...
                <div style={{padding:"10px",border:`1.5px solid ${aiGenerated?AI_COLOR:G[300]}`,borderRadius:"9px",minHeight:"70px",background:"#fff",fontSize:"12px",color:replyText?G[800]:G[400]}}>{replyText||"답글을 입력하세요..."}</div>
