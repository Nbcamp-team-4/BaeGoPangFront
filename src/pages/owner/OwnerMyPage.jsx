// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
//  screens/owner/OwnerMyPage.jsx
//  (고객 MyPage와 구조 동일, 사장님 데이터)
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
      ...
      <div style={{flex:1,overflowY:"auto"}}>
        <div style={{padding:"20px 16px 16px",background:"linear-gradient(160deg,#FFF3E0,#fff)",borderBottom:`1px solid ${G[100]}`}}>
          <div style={{display:"flex",alignItems:"center",gap:"14px"}}>
            ...
            <div style={{flex:1}}><div style={{fontSize:"17px",fontWeight:900}}>{profile.name}</div><div style={{fontSize:"12px",color:G[500],marginTop:"1px"}}>@{profile.nick}</div><div style={{marginTop:"5px"}}><Badge bg={OWNER_COLOR} color="#fff">사장님</Badge></div></div>
          ...
          <div style={{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.45)",zIndex:200,display:"flex",alignItems:"center",justifyContent:"center"}}>
            <div style={{width:"340px",background:"#fff",borderRadius:"16px",padding:"20px",display:"flex",flexDirection:"column",gap:"13px",boxShadow:"0 20px 60px rgba(0,0,0,0.25)"}}>
              ...
              <div style={{display:"flex",gap:"8px"}}>
                ...
                <button onClick={()=>{setProfile({...draft});setEditProfile(false);}} style={{flex:1,padding:"12px",borderRadius:"10px",border:"none",background:OWNER_COLOR,color:"#fff",fontSize:"13px",fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>저장</button>
              </div>
            </div>
          </div>
        )}
