...
import { G, PRIMARY, Chip, StatCard, Badge, AdminShell } from "../components/UI";
    ...
    <div style={{flex:1,overflowY:"auto",padding:"12px 14px",display:"flex",flexDirection:"column",gap:"10px"}}>
      ...
      {tab==="결제 로그"&&<>
        <div style={{display:"flex",gap:"5px",overflowX:"auto"}}>
          {"전체","성공","실패","환불".split(',').map(f=><Chip key={f} label={f} active={logFilter===f} onClick={()=>setLogFilter(f)} color={f==="성공"?"#2E7D32":f==="실패"?"#C62828":f==="환불"?"#E65100":"#1A237E"}/>)}
        </div>
