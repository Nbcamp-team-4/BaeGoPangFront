...
import { G, PRIMARY, PRIMARY_LIGHT, Phone, TopBar, Divider, Input, Btn } from "../components/UI";
...
function Signup({go}){
  ...
  return <Phone noNav>
    <TopBar title="회원가입" go={goTo} backTo="login"/>
    <div style={{flex:1,overflowY:"auto",padding:"16px 20px",display:"flex",flexDirection:"column",gap:"14px"}}>
      ...
      <Btn variant="primary" full onClick={()=>goTo("home")}>가입하기</Btn>
    </div>
  </Phone>;
}
